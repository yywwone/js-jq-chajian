...
<!--上方为手机版导航-->
<div class="container">
	<h3 style=" text-align:center; line-height:1.4em">新闻资讯</h3>
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="row new1" style="margin-bottom:15px;">
		<div class="col-md-3 col-xs-12">
			<a href="<?php echo U('index/new_main');?>"><img class="pho" src="<?php echo ($v['img']); ?>" style="width: 2rem;height: 1rem"></a>
		</div>
		<div class="col-md-7 col-xs-12">
        
    		<h4><a href="<?php echo U('index/new_main');?>" style="color: #000;">杭州宣传片公司</a></h4>
            <p style="overflow: hidden;white-space: nowrap;text-overflow: ellipsis;"><a href="<?php echo U('index/new_main');?>" style="color: #000;"><?php echo ($v['txt']); ?></a>
			</p>
    	</div>
