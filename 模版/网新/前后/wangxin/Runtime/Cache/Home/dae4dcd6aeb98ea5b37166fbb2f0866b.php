...
<div class="container" style="margin-top:2em">
	...
	<div class="video_main">
      ...
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><a href="<?php echo U('index/play',array('type'=>$v["id"],'typ'=>'2'));?>">
       <li style="width:32.5%">
				<div class="video1"> 		
